...
<div class="r-panel-body p-3">
    ...
    <div class="row font-12">
        <div class="col-4">
            ...
            @else
                <img src="{{ asset('user-uploads/candidate-photos/'.$application->photo) }}" class="img-circle img-fluid" width="150">
            @endif
                {{--<div class="col-sm-6">--}}
                    <p class="text-muted resume-button" >
                        <a target="_blank" href="{{ asset('user-uploads/resumes/'.$application->resume) }}" class="btn btn-sm btn-primary">@lang('app.view') @lang('modules.jobApplication.resume')</a>
                    </p>
                {{--</div>--}}
